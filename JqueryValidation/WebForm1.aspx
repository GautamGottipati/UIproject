    ...
    <script>
        function formValidate() {
           alert("Came here");
            ...
            var lastname = document.getElementById('TextBox2').text;
            if (lastname == null) {
            ...
            var emailID = document.getElementById('TextBox3').text;
            if (emailID == null) {
                document.getElementById('tb3Error').innerText = "* Please enter valid email id";
                return false;
            }
            var contactnumber = document.getElementById('TextBox4').text;
